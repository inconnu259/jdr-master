...
export const TONE_MAP: Record<Theme, Record<string, string>> = {
  ...
  'grimoire-emeraude': {
    ...
    'character.choice_deselect_hint': 'Toucher pour désélectionner',
    'character.choice_talents_label': 'Talents',
    'character.choice_advantages_label': 'Avantages',
    'character.choice_required_flag': 'Obligatoire',
    'character.choice_reference_toggle': 'Occupations et actions',
    'character.equipment_group_toggle': '{group}, {n} objets',
    'character.equipment_filter_all': 'Tout',
    'character.equipment_filter_mine': 'Ma sélection',
    'character.equipment_qty_less': 'Retirer un exemplaire de {name}',
    'character.equipment_qty_more': 'Ajouter un exemplaire de {name}',
    ...
    'detail.row_attributes': 'Attributs',
    'detail.row_difficulty': 'Difficulté',
    'detail.row_effect': 'Effet',
    'detail.row_conditions': 'Conditions',
    'detail.narrative_show': 'Lire le récit',
    'detail.narrative_hide': 'Masquer le récit',
    'character.equipment_group_individual': 'Objets',
    'character.equipment_group_contenant': 'Contenants',
    'character.equipment_group_animal': 'Animaux',
    'character.equipment_search_label': 'Rechercher un objet',
    'character.equipment_search_placeholder': 'Rechercher un objet…',
    'character.equipment_budget': 'Budget · {spent} / {total} Po',
    'character.equipment_over_budget': '— dépassement de {n} Po',
    'character.equipment_search_empty': 'Aucun objet ne répond à cet appel…',
  ...
  'foret-ancienne': {
    ...
    'character.equipment_budget': 'Budget · {spent} / {total} Po',
    'character.equipment_over_budget': '— dépassement de {n} Po',
    'character.equipment_search_empty': 'La forêt ne recèle aucun objet de ce nom…',
    'character.tab_label': 'Personnages',
  ...
  'medieval-steampunk': {
    ...
    'character.equipment_budget': 'Budget · {spent} / {total} Po',
    'character.equipment_over_budget': '— dépassement de {n} Po',
    'character.equipment_search_empty': 'Aucun mécanisme ne porte ce nom dans l’atelier…',
    'character.tab_label': 'Personnages',
