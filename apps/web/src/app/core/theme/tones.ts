...
export const TONE_MAP: Record<Theme, Record<string, string>> = {
  ...
  'grimoire-emeraude': {
    ...
    'alert.missing_player':     'Certains membres n\'ont pas encore consulté l\'oracle.',
  ...
  'foret-ancienne': {
    ...
    'empty.no_slots':           'Aucune clairière libre. La forêt est dense, demandez aux membres leurs disponibilités.',
    ...
    'alert.missing_player':     'Certains membres n\'ont pas encore parcouru la forêt.',
  ...
  'medieval-steampunk': {
    ...
    'alert.missing_player':     'Certains membres n\'ont pas alimenté le registre.',
