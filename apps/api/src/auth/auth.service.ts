...
const RESET_TOKEN_INVALID_MESSAGE = 'Lien invalide ou expiré. Merci de refaire une demande.';
...
const EMAIL_CHANGE_TOKEN_INVALID_MESSAGE = 'Lien invalide ou expiré. Merci de refaire une demande.';
